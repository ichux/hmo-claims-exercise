...
# from app.forms import AddUser, ClaimForm
...
#
#     # form = ClaimForm()
#     # form.patient.choices = [(user.id, user.name) for user in User.query.all()]
#     # if form.validate_on_submit():
#     #     claim = Claim(
#     #         user_id=form.patient.data,
...
#     #             cost_of_service=service_form.cost.data,
#     #         )
#     #         database.session.add(service)
#     #         total_cost += service.cost_of_service
#     #     service_charge = total_cost * 0.1
#     #     final_cost = total_cost + service_charge
#     #     claim.total_cost = total_cost
#     #     claim.service_charge = service_charge
#     #     claim.final_cost = final_cost
#     #     database.session.commit()
#     #     flash("Claim created successfully!", "success")
#     #     return redirect(url_for("view_claims"))
#     # return render_template("home/create_claim.html", form=form)
#
#
